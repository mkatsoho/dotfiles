...
# xrandr --output eDP-1 --output DP-1 --off --output HDMI-1 --off --output HDMI-2 --primary --mode  "2560x1080_60.00" --pos 0x0 --rotate normal

# xrandr --output eDP-1 --mode 1600x900 --pos 2560x180 --rotate normal --output DP-1 --off --output HDMI-1 --off --output HDMI-2 --primary --mode 2560x1080_60.00 --pos 0x0 --rotate normal
#!/bin/sh
